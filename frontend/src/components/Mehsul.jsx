...
<div className="w-full flex flex-col justify-between h-auto max-w-sm bg-white border border-gray-200  shadow-sm dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="px-5 pb-5">
        <a href="#" className='relative top-[-25px]'>
            <h5 className="text-[13px] font-semibold tracking-tight text-gray-900 dark:text-white">{mehsulAdiProps}</h5>
        </a>
        ...
        <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
    </div>
</div>
